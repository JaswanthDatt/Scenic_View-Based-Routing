...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript">
       ...
       /**
       *  this fucntion executes doLoad and Loaddata functions
       *   
       */
        function load() {
            doLoad();
      ...
      /**
      *  this function creates markers @ various waypoints
      *  such that each marker is equidistant to 1/8 the address 
      ...
      */
       ...
       /**
      *  this function creates markers @ source
      *  and destination   
      */
       ...
       /*
       * this function loads map with traffic layer
       * and adds to the direction display.
       */
       ...
       */
       ...
       /*
       * this function creates a marker @ every point(lat,long)
       * 
       * @param point
       */
       ...
       */
       ...
       /*
       * this function creates a scenic route
       * through all the waypoints 
       * @param point
       */
        function scenic_route() {
            console.log("enetered scenic route waypoints ");
