...
/**
 * This program directs user through the routing paths between 
 * source and destination using the most scenic routes as a criterion.
 * Markers are placed @ a distance of 1/8 th the distance between source and destination.
 * Google maps allows only 8 way points. 
 * Each markers is considered as a focal point and most scenic place from the around the marker is choosen 
 * and continued for remaining markers.Route through these places is plotted to give the most scenic route
 */
...
public partial class Direction : System.Web.UI.Page
{
    ...
    /**
      * Method to decode the Latitude & Longitude of a given place to Address Format
      * using ReverseCode GoogleLocationService
      * 
      * @param lat_long
      *
      */
    ...
    /**
     * Method to create a list of scenic places  and write to database
     * 
     * @return string[]
     *
     */
    ...
    /*
    * this method writes all the content from dataset
    * to the database
    * @param ds(DataSet)
    */
